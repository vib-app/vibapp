...
cp "$runtime_daemon_root/vibapp_daemon/host_storage.py" "$contents/Resources/runtime-daemon/vibapp_daemon/host_storage.py"
cp "$runtime_daemon_root/vibapp_daemon/scheduler_backend.py" "$contents/Resources/runtime-daemon/vibapp_daemon/scheduler_backend.py"
cp "$runtime_daemon_root/vibapp_daemon/windows_security.py" "$contents/Resources/runtime-daemon/vibapp_daemon/windows_security.py"
cp "$runtime_daemon_root/vibapp_daemon/windows_transport.py" "$contents/Resources/runtime-daemon/vibapp_daemon/windows_transport.py"
